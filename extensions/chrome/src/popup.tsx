        ...
        return (
          <div className="flex min-w-0 items-center gap-3" key={server.port}>
            ...
            <div className="min-w-0 flex-1">
              <div className="truncate text-sm font-semibold text-stone-200">{label}</div>
  ...
  return (
    <section className="border-b border-stone-700 bg-stone-800 px-3 py-3">
      <div className="mb-2 flex items-center justify-between">
        <div>
          <div className="text-sm font-semibold text-stone-200">MCP Servers</div>
    ...
    <section className="border-t border-stone-700 bg-stone-800 px-3 py-3">
      <div className="mb-2 flex items-start gap-2">
        ...
        <div className="min-w-0">
          <div className={cn('truncate text-sm font-medium', isCurrentTabConnected ? 'text-teal-400' : 'text-stone-300')} title={title}>
            {title}
          </div>
...
function PopupApp() {
  ...
  return (
    <div className="w-[280px] overflow-hidden rounded-none bg-stone-900 text-stone-100 shadow-none">
      <header className="flex items-center justify-between bg-stone-950 px-3 py-2.5 text-stone-100">
        <div>
        ...
        <Button
          aria-label="Settings"
          className="text-stone-300 hover:bg-stone-700 hover:text-stone-100"
